...
export const ReligiousInfoSection: React.FC<ReligiousInfoSectionProps> = ({ register, errors, control }) => {
  ...
  return (
    <Card id="religious-info">
      ...
      <CardContent>
        ...
        <DynamicKeyValueField sectionId="religious-info" control={control} />
      </CardContent>
    </Card>
  );
};
