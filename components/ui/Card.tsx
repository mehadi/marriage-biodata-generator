      ...
      return (
        <div
          ...
          className={cn(
            ...
            hoverable && 'hover:shadow-md hover:border-emerald-200 dark:hover:border-emerald-800',
            className
          )}
          {...props}
        >
    ...
    return (
      <div
        ...
        className={cn(
          ...
          'dark:border-slate-700 dark:bg-slate-800',
          'transition-all duration-200 ease-in-out',
          hoverable && 'hover:shadow-md hover:border-emerald-200 hover:-translate-y-0.5 dark:hover:border-emerald-800',
          className
        )}
        {...props}
      >
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, CardTitleProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <h3
        ref={ref}
        className={cn('text-xl font-semibold leading-tight text-slate-900 dark:text-slate-100', className)}
        {...props}
      >
        {children}
      </h3>
